...
_LAZY_EXPORTS = {
    ...
    "BacktestAlphaAdaptation": ("backtest_alpha_adapter", "BacktestAlphaAdaptation"),
    "BacktestAlphaAdapterError": ("backtest_alpha_adapter", "BacktestAlphaAdapterError"),
    "BacktestSignalProvenance": ("backtest_alpha_adapter", "BacktestSignalProvenance"),
    "adapt_backtest_signal_to_alpha": ("backtest_alpha_adapter", "adapt_backtest_signal_to_alpha"),
    ...
    "MicrostructureCostEvidence": ("microstructure_cost_evidence", "MicrostructureCostEvidence"),
    "MicrostructureCostEvidenceError": ("microstructure_cost_evidence", "MicrostructureCostEvidenceError"),
    "derive_microstructure_cost_evidence": ("microstructure_cost_evidence", "derive_microstructure_cost_evidence"),
    "write_microstructure_cost_evidence": ("microstructure_cost_evidence", "write_microstructure_cost_evidence"),
    ...
    "StrategyEdgeReviewConfig": ("strategy_edge_improvement", "StrategyEdgeReviewConfig"),
    "StrategyEdgeImprovementReport": ("strategy_edge_improvement", "StrategyEdgeImprovementReport"),
    "StrategyEdgeWrittenReport": ("strategy_edge_improvement", "StrategyEdgeWrittenReport"),
    "build_strategy_edge_improvement_report": (
        "strategy_edge_improvement",
        "build_strategy_edge_improvement_report",
    ),
    "write_strategy_edge_improvement_report": (
        "strategy_edge_improvement",
    ...
    "AdvancedMarketAnalysisSnapshot": ("advanced_market_analysis", "AdvancedMarketAnalysisSnapshot"),
    "build_advanced_market_analysis_snapshots": (
        "advanced_market_analysis",
        "build_advanced_market_analysis_snapshots",
    ),
    "preferred_market_context_by_symbol": ("advanced_market_analysis", "preferred_market_context_by_symbol"),
    "DeflatedSharpeConfig": ("statistical_validation", "DeflatedSharpeConfig"),
    "DeflatedSharpeResult": ("statistical_validation", "DeflatedSharpeResult"),
    "PFQualityAssessment": ("statistical_validation", "PFQualityAssessment"),
    "assess_deflated_sharpe": ("statistical_validation", "assess_deflated_sharpe"),
    "evaluate_progressive_pf_quality": ("statistical_validation", "evaluate_progressive_pf_quality"),
