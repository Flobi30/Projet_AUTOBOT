...
class MeanReversionShadowConfig:
    ...
    def from_env(cls) -> "MeanReversionShadowConfig":
        return cls(
            ...
            min_tick_seconds=_env_int("MEAN_REVERSION_SHADOW_MIN_TICK_SECONDS", 30, 0, 86_400),
            ...
            min_samples_for_signal=_env_int("MEAN_REVERSION_SHADOW_MIN_SAMPLES", 64, 1, 100_000),
...
class MeanReversionShadowLab:
    ...
    def _run_variant_tick(self, state: MeanReversionState, variant: MeanReversionVariant, price: float, timestamp: str) -> None:
