# P18C Alpha Hypothesis Runner - p18c_alpha_hypothesis_runner_20260709
...
|---|---|---:|---:|---|---|---:|---|
| `DATA_CHECK` | `KEEP_RESEARCH` | True | False | `AUTO_ALLOWED` | `neutral` | 26.752349 | data_ready |
| `FAST_NET_EDGE_TEST` | `KEEP_RESEARCH` | True | False | `AUTO_ALLOWED` | `neutral` | 53.179253 | positive_smoke_requires_walk_forward_before_shadow, no_shadow_or_paper_allowed |
